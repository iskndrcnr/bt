...
// @match        https://*.voc-tester.com/backend.php?r=applicant/create
...
*/
    ...
    if(/applicant\/create/.test(window.location.href)){//aday kayıt ederken aday mevcutsa uyarı göster
