...
*/
    ...
    if(/applicant\/create/.test(window.location.href)){
        $('#Applicant_tc_number').on('blur', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.Applicant_tc_number[0].includes("kayıtlıdır") || data.Applicant_tc_number[1].includes("kayıtlıdır") || data.Applicant_tc_number[3].includes("kayıtlıdır"))
                    {
                        $( ".iskokayitli" ).remove();
